...
namespace AquaFan
{
    public class Controller
    {
        ...
        private bool bApplyChangesWhenChangingActiveProfile;

        public bool ApplyChangesWhenChangingActiveProfile
        {
            get { return bApplyChangesWhenChangingActiveProfile; }
            set { bApplyChangesWhenChangingActiveProfile = value; }
        }
        ...
        /// <summary>
        /// Gibt die Fan-Settings zum Starten der aquaComputerCmd.exe zurück (True für Gesetze Fan Werte, False für 100% Werte)
        /// </summary>
        ...
        private void applyFanSpeeds(string startArguments)
        {
            ...
            pApplyChangesStartInfo.Arguments = " -sn:" + xmlCntrl.getDeviceSerial() + startArguments;
